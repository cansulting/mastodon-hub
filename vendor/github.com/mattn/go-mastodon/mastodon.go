...
func (c *Client) DoAPI(ctx context.Context, method string, uri string, params interface{}, res *[]byte, pg *Pagination) error {
...
func (c *Client) doAPI(ctx context.Context, method string, uri string, params interface{}, res interface{}, pg *Pagination) error {
	var output []byte
	err := c.DoAPI(ctx, method, uri, params, &output, pg)
	if err != nil {
		return err
	}
	return json.Unmarshal(output, res)
}
